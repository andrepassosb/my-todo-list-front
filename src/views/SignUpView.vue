  ...
  <form action @submit.prevent="handleSignIn" class="LoginView">
    ...
    <div class="input-container">
      ...
      <div class="form-control text-start mb-4">
        ...
        <input type="password" id="password-field" v-model="state.password" required>
      </div>
      <div class="form-control text-start mb-4">
        <label class="position-absolute" for="confirmpassword">Confirme a senha</label>
        <input type="password" id="confirmpassword-field" v-model="state.confirmpassword" required>
      </div>
      <button
        id="submit-button"
        type="submit"
